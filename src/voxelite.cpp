...
int init()
{
    ...
    Shader base_shader = Shader(ASSETS_DIR+"shaders/base_shader.vsh", ASSETS_DIR+"shaders/base_shader.fsh");
    ...
    Shader quad_shader = Shader(ASSETS_DIR+"shaders/quad.vsh", ASSETS_DIR+"shaders/quad.fsh");
    Shader quad_shader2 = Shader(ASSETS_DIR+"shaders/quad2.vsh", ASSETS_DIR+"shaders/quad2.fsh");
